...
> Previamente debemos ejecutar el `./StartServer` que esta en la ruta `Minecraft_de_0_TAP/AdventuresInMinecraft-Linux-master`</br>
...
> Primeramente nos debemos ubicar en la ruta de `Minecraft_de_0_TAP/AdventuresInMinecraft-Linux-master/minecraft_agent_framework/agents`</br>
...
> Pasos para ejecutar `zombiBot.py`</br>
> Previamente debemos ejecutar el `./StartServer` que está en la ruta `Minecraft_de_0_TAP/AdventuresInMinecraft-Linux-master`</br>
> Primeramente nos debemos ubicar en la ruta de `Minecraft_de_0_TAP/AdventuresInMinecraft-Linux-master/minecraft_agent_framework/Pyro4`</br>
...
> Primeramente nos debemos ubicar en la ruta de `Minecraft_de_0_TAP/AdventuresInMinecraft-Linux-master/minecraft_agent_framework/Tarragona`</br>
